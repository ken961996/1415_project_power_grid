...
UGraph = snap.LoadEdgeList(snap.PUNGraph, "north_america_power.txt", 0, 1)
PRankH = snap.TIntFltH()
snap.GetPageRank(UGraph, PRankH)

#PageRank
with open('na_power_pageranks.csv', 'w') as csvfile:
...
with open('na_power_eigcentr.csv', 'w') as csvfile:
...
with open('na_power_degcentr.csv', 'w') as csvfile:
